	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	GammaEngine::Ref<GammaEngine::VertexBuffer> vertexBuffer = GammaEngine::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	GammaEngine::Ref<GammaEngine::IndexBuffer> indexBuffer = GammaEngine::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	GammaEngine::Ref<GammaEngine::VertexBuffer> squareVB = GammaEngine::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ GammaEngine::ShaderDataType::Float3, "a_Position" },
	...
	GammaEngine::Ref<GammaEngine::IndexBuffer> squareIB = GammaEngine::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
	...
	m_ChernoLogoTexture = GammaEngine::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(GammaEngine::Timestep ts)
{
	// Update
	...
	m_Texture->Bind();
	GammaEngine::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
...
void ExampleLayer::OnEvent(GammaEngine::Event& e)
{
