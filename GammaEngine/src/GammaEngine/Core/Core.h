...
// Platform detection using predefined macros
	...
	#ifdef _WIN64
		/* Windows x64  */
		#define GAMMAENGINE_PLATFORM_WINDOWS
	#else
		/* Windows x86 */
	 ...
	 * and not some other Apple platform */
		...
		#define GAMMAENGINE_PLATFORM_IOS
		#error "IOS is not supported!"
	#elif TARGET_OS_MAC == 1
		#define GAMMAENGINE_PLATFORM_MACOS
	...
	#define GAMMAENGINE_PLATFORM_ANDROID
	#error "Android is not supported!"
#elif defined(__linux__)
	#define GAMMAENGINE_PLATFORM_LINUX
...
// DLL support
	...
	#endif
#else
	#error GammaEngine only supports Windows!
